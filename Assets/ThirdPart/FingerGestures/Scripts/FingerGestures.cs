...
public class FingerGestures : MonoBehaviour
{
    ...
    private void InstallInputProvider( )
    {
        ...
        {
            Debugger.LogError( "Invalid InputProvider (null)" );
            return;
        }
        */

//        Debugger.Log( "FingerGestures: using " + inputProviderPrefab.name );
        ...
        if (IsTouchScreenPlatform(Application.platform)) {
            ...
            //todo: Debugger.Log("FingerGestures: using " + prefabName);
    ...
    public static void Register( GestureRecognizer recognizer )
    {
        ...
        //Debugger.Log( "Registered gesture recognizer: " + recognizer );
    }
    ...
    void CheckInit()
    {
        ...
        {
            //todo: Debugger.LogWarning( "There is already an instance of FingerGestures created (" + instance.name + "). Destroying new one." );
    ...
    void Update()
    {
        ...
        {
            //todo: Debugger.Log( "UnityRemote presence detected. Switching to touch input." );
...
iPhone4        64060  326 ppi 
iPhone4S       64060  326 ppi 
iPhone5        640136 326 ppi 
