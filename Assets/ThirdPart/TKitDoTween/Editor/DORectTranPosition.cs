...
[CustomEditor (typeof (HCTweenRectTranPosition)), CanEditMultipleObjects]
public class DORectTranPosition : Editor {

	HCTweenRectTranPosition obj;
	...
	void OnEnable () {
		obj = (HCTweenRectTranPosition) target;
