...
namespace XLua.LuaDLL
{
    ...
    public partial class Lua
	{
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_crypt_core(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadCryptCore(System.IntPtr L)
        {
            return luaopen_crypt_core(L);
        }
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_lkcp(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadLkcp(System.IntPtr L)
        {
            return luaopen_lkcp(L);
        }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_timer_core(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadTimerCore(System.IntPtr L)
        {
            return luaopen_timer_core(L);
        }

        // [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        // public static extern int luaopen_lfs(System.IntPtr L);

        // [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        // public static int LoadLfs(System.IntPtr L)
        // {
        //     return luaopen_lfs(L);
        // }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_map_core(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadMapCore(System.IntPtr L)
        {
            return luaopen_map_core(L);
        }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_i18n_core(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadI18nCore(System.IntPtr L)
        {
            return luaopen_i18n_core(L);
        }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_traceback(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadTraceback(System.IntPtr L)
        {
            return luaopen_traceback(L);
        }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_random(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadRandom(System.IntPtr L)
        {
            return luaopen_random(L);
        }

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern int luaopen_lutil(System.IntPtr L);

        [MonoPInvokeCallback(typeof(LuaDLL.lua_CSFunction))]
        public static int LoadLutil(System.IntPtr L)
        {
            return luaopen_lutil(L);
        }
    }
}
