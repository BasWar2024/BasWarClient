...
public class LuaCallCs : MonoBehaviour
{
	...
	string script = @"
        function demo()
            ...
            print(testobj:GetSomeBaseData()) --Extension methods
            testobj:GenericMethodOfString()  --Extension methods
            ...
            testobj.TestDelegate = lua_delegate + testobj.TestDelegate --combineC#delegate
            testobj.TestDelegate('hello')
