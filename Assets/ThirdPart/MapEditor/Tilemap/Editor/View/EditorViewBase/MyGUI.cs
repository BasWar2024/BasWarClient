...
namespace CanglxMapEditor.Utillity {
	...
	public static class MyStyles {
		...
		public static readonly GUIStyle rightMiniLabel;
		...
		static MyStyles () {
			...
			rightBoldLabel.wordWrap = true;

			rightMiniLabel = new GUIStyle (EditorStyles.miniLabel);
			rightMiniLabel.alignment = TextAnchor.MiddleRight;
			rightMiniLabel.wordWrap = true;
