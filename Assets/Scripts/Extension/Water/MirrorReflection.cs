...
public class MirrorReflection : MonoBehaviour
{
    ...
    public static RenderTexture m_ReflectionTexture = null;
...
//	public float shoreLineDepth = 50;
//	public LayerMask shoreLineDetectLayer;
	public float alpha = 1;


	static MirrorReflection _instance;
	public static MirrorReflection instance{
		get{
			if(_instance == null){
				_instance = GameObject.FindObjectOfType(typeof(MirrorReflection)) as MirrorReflection;
			}
			return _instance;
		}
	}
...
//		bool isPro = UnityEditorInternal.InternalEditorUtility.HasPro();
	...
	void LateUpdate()
    {
		...
		oceanMaterial.shader.maximumLOD = maximumLOD;
...
//        Matrix4x4 mtx = transform.localToWorldMatrix * Matrix4x4.Scale( new Vector3(1.0f/scale.x, 1.0f/scale.y, 1.0f/scale.z) );
		Matrix4x4 mtx = Matrix4x4.Scale( new Vector3(1.0f/scale.x, 1.0f/scale.y, 1.0f/scale.z) );
        mtx = scaleOffset * cam.projectionMatrix * cam.worldToCameraMatrix * mtx;
        oceanMaterial.SetMatrix( "_ProjMatrix", mtx ); 
...
//	[ContextMenu ("Reset Shore Line")]
//	void ResetShoreLine()
//	{
//		Component[] shorelines = transform.GetComponentsInChildren(typeof(ShoreLine));
//		foreach(ShoreLine sl in shorelines){
//			sl.shoreLineDetectLayer = shoreLineDetectLayer;
//			sl.InitShoreLine();
//		}
//	}
