        ...
        IDictionary<string, object> {
            ...
            public int GetInt (string key) {
                if (_members.ContainsKey (key)) {
                    ...
                    //Debug.LogWarningFormat("method GetInt not find key:\"{0}\"",key);
                }
...
#if _CLIENTLOGIC_
                    Debug.LogWarningFormat ("GetLong GetInt not find key:\"{0}\"", key);
#endif
            ...
            public float GetFloat (string key) {
                if (_members.ContainsKey (key)) {
                    ...
                    //Debug.LogWarningFormat("method GetFloat not find key:\"{0}\"",key);
                }
            ...
            public string GetString (string key) {
                if (_members.ContainsKey (key)) {
                    return _members[key] as string;
                } else {
#if _CLIENTLOGIC_
                    Debug.LogError ("" + key + "key");
#endif
                // Debug.LogWarningFormat ("method GetString not find key:\"{0}\"", key);
            }
            return "";
            }
...
#if _CLIENTLOGIC_
                    Debug.LogWarningFormat ("method GetBoolean not find key:\"{0}\"", key);
#endif
            }
            return false;
            }
...
#if _CLIENTLOGIC_
                    Debug.LogWarningFormat ("method GetJsonObject not find key:\"{0}\"", key);
#endif
            }
            return null;
            }
...
#if _CLIENTLOGIC_
                    Debug.LogWarningFormat ("method GetJsonArray not find key:\"{0}\"", key);
#endif
            }
            return null;
            }
    ...
    static class SimpleJson {
        ...
        private static string ConvertFromUtf32 (int utf32) {
            ...
            return new string (new char[] {
                (char) ((utf32 >> 10) + 0xD800), (char) (utf32 % 0x0400 + 0xDC00)
            });
        }
