...
//            owner.FindDestoryWall(out m_Wall1, out m_Wall2);
...
//                    NewGameData._EffectFactory.CreateEffect("Missile_spine",
//                        new FixVector3((Fix64)value.Wall.position.x, (Fix64)value.Wall.position.y, (Fix64)value.Wall.position.z), Fix64.Zero);
//                    m_TotalKillWallNum++;
//                }
//            }
